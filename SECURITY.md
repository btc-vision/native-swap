...
|--------------------|---------|---------------------------------------|
| native-swap   | Audited | [Verichains](https://verichains.io)   |
...
Report vulnerabilities through [GitHub Security Advisories](https://github.com/btc-vision/native-swap/security/advisories/new).
