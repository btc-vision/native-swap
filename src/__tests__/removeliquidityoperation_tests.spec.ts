...
describe('RemoveLiquidityOperation tests', () => {
    ...
    describe('RemoveLiquidityOperation - pre conditions', () => {
        beforeEach(() => {
            clearCachedProviders();
            Blockchain.clearStorage();
            Blockchain.clearMockedResults();
        ...
        it('should revert if provider is not a liquidity provider', () => {
            expect(() => {
        ...
        it('should revert if provider is the initial provider', () => {
            expect(() => {
                setBlockchainEnvironment(100);
        ...
        it('should revert if provider has listed tokens', () => {
            expect(() => {
                setBlockchainEnvironment(100);
        ...
        it('should revert if provider is already in pending removal state', () => {
    ...
    describe('RemoveLiquidityOperation - transfer and update provider', () => {
        beforeEach(() => {
            clearCachedProviders();
            Blockchain.clearStorage();
            Blockchain.clearMockedResults();
        ...
        it('should revert if satoshis owed = 0', () => {
            setBlockchainEnvironment(100, msgSender1, msgSender1);
            Blockchain.mockValidateBitcoinAddressResult(true);
        ...
        it('should revert if liquidityProvided = 0', () => {
            setBlockchainEnvironment(100, msgSender1, msgSender1);
            Blockchain.mockValidateBitcoinAddressResult(true);
        ...
        it('should succeed => transfer tokens, update liquidity queue reserve, update provider, emit event', () => {
            setBlockchainEnvironment(100, msgSender1, msgSender1);
            Blockchain.mockValidateBitcoinAddressResult(true);
