...
describe('AddLiquidityOperation tests', () => {
    ...
    describe('AddLiquidityOperation pre conditions', () => {
        beforeEach(() => {
            clearCachedProviders();
            Blockchain.clearStorage();
            Blockchain.clearMockedResults();
        ...
        it('should revert if provider is in removal queue', () => {
            expect(() => {
    ...
    describe('AddLiquidityOperation reservation validation', () => {
        beforeEach(() => {
            clearCachedProviders();
            Blockchain.clearStorage();
            Blockchain.clearMockedResults();
        ...
        it("should revert if reservation is not for liquidity pool'", () => {
            expect(() => {
                setBlockchainEnvironment(100);
    ...
    describe('AddLiquidityOperation execute', () => {
        beforeEach(() => {
            clearCachedProviders();
            Blockchain.clearStorage();
            Blockchain.clearMockedResults();
        ...
        it('should revert if no purchase made', () => {
            expect(() => {
        ...
        it('should revert if reservation is at same block', () => {
            setBlockchainEnvironment(100, msgSender1, msgSender1);
            Blockchain.mockValidateBitcoinAddressResult(true);
        ...
        it('should revert if activation delay not reached', () => {
            setBlockchainEnvironment(100, msgSender1, msgSender1);
            Blockchain.mockValidateBitcoinAddressResult(true);
        ...
        it('should update liquidity provided but not the BTC receiver when already LP', () => {
            setBlockchainEnvironment(100, msgSender1, msgSender1);
            Blockchain.mockValidateBitcoinAddressResult(true);
            ...
            expect(provider2.getBtcReceiver()).toStrictEqual(receiverAddress2);
            ...
            provider2.setReservedAmount(u128.fromU32(1000));
