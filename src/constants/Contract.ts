...
export const STRICT_MINIMUM_PROVIDER_RESERVATION_AMOUNT_IN_SAT: u256 = u256.fromU32(600);
export const MINIMUM_PROVIDER_RESERVATION_AMOUNT_IN_SAT: u256 = u256.fromU32(1000);
export const MINIMUM_LIQUIDITY_VALUE_ADD_LIQUIDITY_IN_SAT: u256 = u256.fromU32(10_000);
export const MINIMUM_TRADE_SIZE_IN_SAT: u256 = u256.fromU32(10_000);
